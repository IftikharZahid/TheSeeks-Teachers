...
import { View, Text, TouchableOpacity, StyleSheet, Animated, Modal, TouchableWithoutFeedback, StatusBar } from 'react-native';
            ...
            <TouchableWithoutFeedback>
              <View style={[styles.dropdownContainer, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={[styles.dropdownHeader, { borderBottomColor: theme.border }]}>
                  ...
                  <TouchableOpacity onPress={() => { setShowDropdown(false); navigation.navigate('Home', { screen: 'LibraryScreen' }) }}>
                    ...
                    if (update.type === 'notice') {
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          onPress={() => { setShowDropdown(false); navigation.navigate('Home', { screen: 'LibraryScreen', params: { noticeId: n.id } }) }}
                          activeOpacity={0.7}
                        >

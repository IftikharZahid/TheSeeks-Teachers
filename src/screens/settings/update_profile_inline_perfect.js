...
const oldModalScroll = `<ScrollView style={{ width: '100%', maxHeight: scale(400) }} showsVerticalScrollIndicator={false}>
...
content = content.replace(oldModalScroll, newModalScroll);

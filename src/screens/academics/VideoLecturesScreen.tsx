...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Dimensions, RefreshControl, ActivityIndicator, StatusBar } from 'react-native';
      ...
      >
        <Ionicons name="arrow-back" size={scale(22)} color={isDark ? theme.text : '#ffffff'} />
                ...
                <TouchableOpacity
                    ...
                    style={[styles.actionButton, { backgroundColor: isDark ? theme.border : 'rgba(255,255,255,0.2)' }]}
                >
                    <Ionicons
                        name={isFavorite ? "heart" : "heart-outline"}
                        size={18}
                        color={isFavorite ? "#ef4444" : (isDark ? theme.text : "#fff")}
                    />
                </TouchableOpacity>
            </View>

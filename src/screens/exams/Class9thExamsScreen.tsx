...
export const Class9thExamsScreen: React.FC = () => {
  ...
  const dynamicTestOptions = (() => {
    ...
    exams.filter(e => (e.studentClass || '').trim() === '9th')
  ...
  const filteredExams = (() => {
    const classExams = exams.filter(e => (e.studentClass || '').trim() === '9th');
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
      ...
      <View style={[styles.header, { backgroundColor: theme.card, borderBottomColor: theme.border }]}>
        ...
        <View style={styles.headerTitleBlock}>
          <Text style={[styles.headerTitle, { color: theme.text }]}>Class 9th Exams</Text>

...
export const Class1stYearExamsScreen: React.FC = () => {
  ...
  const dynamicTestOptions = (() => {
    ...
    exams.filter(e => (e.studentClass || '').trim() === '1st Year')
  ...
  const filteredExams = (() => {
    const classExams = exams.filter(e => (e.studentClass || '').trim() === '1st Year');
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
      ...
      <View style={[styles.header, { backgroundColor: theme.card, borderBottomColor: theme.border }]}>
        ...
        <View style={styles.headerTitleBlock}>
          <Text style={[styles.headerTitle, { color: theme.text }]}>1st Year Exams</Text>

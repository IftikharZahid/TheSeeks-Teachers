...
export const Class10thExamsScreen: React.FC = () => {
  ...
  const dynamicTestOptions = (() => {
    ...
    exams.filter(e => (e.studentClass || '').trim() === '10th')
  ...
  const filteredExams = (() => {
    const classExams = exams.filter(e => (e.studentClass || '').trim() === '10th');
    ...
    <View style={[styles.container, { backgroundColor: isDark ? theme.background : '#f8fafc', paddingTop: StatusBar.currentHeight || 0 }]}>
        ...
        <View style={[styles.header, { backgroundColor: isDark ? theme.card : theme.primary, borderBottomColor: isDark ? theme.border : 'transparent' }]}>
          ...
          <View style={styles.headerTitleBlock}>
            <Text style={[styles.headerTitle, { color: isDark ? theme.text : '#ffffff' }]} numberOfLines={1} adjustsFontSizeToFit>10th Class Exams</Text>
                ...
                <>
                  ...
                  {showStudentDropdown && (() => {
                    ...
                    const classStudents = students.filter(s => {
                      ...
                      return g === '10th' || g === 'class 10th' || g === '10';
                    });

...
files.forEach(file => {
  ...
  // 9. auth calls in handleSaveExam
  content = content.replace(
  ...
  // 11. handleSaveExam handleDuplicate
  content = content.replace(
  ...
  // 13. UI - Section Header Restricted
  content = content.replace(
...
console.log('Done replacing multiple subjects logic.');

...
// ΓöÇΓöÇΓöÇ Shared Dropdown Component ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Types & Constants ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Teacher Authorization Utilities ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Memoized row component ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export const GenericExamsScreen: React.FC = () => {
  const route = useRoute<any>();
  const targetClass = route.params?.selectedClass || 'Unknown Class';
  const navigation = useNavigation<any>();
  const { theme, isDark } = useTheme();
  const dispatch = useAppDispatch();

  // ΓöÇΓöÇ Fetch exam settings (Test Nos + Categories) from web dashboard on mount ΓöÇΓöÇ
  useEffect(() => {
  ...
  const handleSaveExam = async () => {
    ...
    // ΓöÇΓöÇΓöÇ Teacher Authorization Check ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    if (isTeacher) {
    ...
    const examData: any = {
      ...
      // ΓöÇΓöÇΓöÇ Teacher Tracking ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  const handleDeleteExam = async (id: string) => {
    ...
    // ΓöÇΓöÇΓöÇ Teacher Authorization Check ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    if (isTeacher) {
  ...
  const handlePickDocument = async () => {
    try {
      ...
      // ΓöÇΓöÇΓöÇ Teacher Authorization Check for Bulk Upload ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        if (item.title && item.category) {
          try {
            ...
            const examDoc: any = {
              ...
              updatedAt: serverTimestamp(),
              // ΓöÇΓöÇΓöÇ Teacher Tracking for Bulk Upload ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
              ...(isTeacher && { teacherId, createdBy: teacherId }),
            };
      ...
      const sampleData = [
        {
          ...
          studentClass: targetClass, title: 'T1', category: 'Monthly', date: '2024-03-20',
  ...
  const dynamicTestOptions = (() => {
    ...
    exams.filter(e => (e.studentClass || '').trim().toLowerCase() === targetClass.toLowerCase())
  ...
  const filteredExams = (() => {
    const classExams = exams.filter(e => (e.studentClass || '').trim().toLowerCase() === targetClass.toLowerCase());
  ...
  const studentProgressList = (() => {
    ...
    return Array.from(map.values()).sort((a, b) => {
      const parseRollNo = (roll: string) => {
        const num = parseInt(roll.replace(/\D/g, ''), 10);
        return isNaN(num) ? 0 : num;
      };
      return parseRollNo(a.rollNo) - parseRollNo(b.rollNo);
    });
  })();
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'left', 'right']}>
      ...
      {/* ΓöÇΓöÇ Tap-outside overlay to dismiss dropdowns ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Filter Dropdowns Row ΓöÇΓöÇ */}
      <View style={styles.filterRow}>

        {/* ΓöÇΓöÇ Filter: Test No ΓöÇΓöÇ */}
      ...
      <Modal visible={modalVisible} animationType="slide" transparent statusBarTranslucent>
        <View style={{ flex: 1, backgroundColor: theme.background }}>
          <View style={{ flex: 1, paddingTop: (StatusBar.currentHeight || 30) }}>
            ...
            >
            {/* ΓòÉΓòÉΓòÉ Student Info Section ΓòÉΓòÉΓòÉ */}
                ...
                <>
                  ...
                  <View style={[styles.row, { zIndex: 2000 }]}>
                    ...
                    <View style={[styles.col, { flex: 0.35, zIndex: 2000 }]}>
                      ...
                      <View style={{ position: 'relative', zIndex: 2000 }}>
                        ...
                        {/* Γû╝ REPLACED: Title / Test No Dropdown ΓÇö 5 visible, scrollable */}
                        {showTitleDropdown && (
                  ...
                  {showStudentDropdown && (() => {
                    ...
                    const classStudents = students.filter(s => {
                      ...
                      const t = targetClass.toLowerCase();
                      return g === t || g === `class ${t}` || g === t.replace('class ', '');
                    });
            ...
            {/* ΓòÉΓòÉΓòÉ Exam Info Section ΓòÉΓòÉΓòÉ */}
            <View style={[styles.sectionCard, { backgroundColor: theme.card, borderColor: theme.border, zIndex: 2000, elevation: 2 }]}>
              ...
              <View style={[styles.row, { zIndex: 1500 }]}>
                <View style={[styles.col, { flex: 0.55, position: 'relative', zIndex: 1500 }]}>
                  ...
                  {/* Γû╝ REPLACED: Category Dropdown ΓÇö 5 visible, scrollable */}
            ...
            {/* ΓòÉΓòÉΓòÉ Marks & Books Section ΓòÉΓòÉΓòÉ */}
            <View style={[styles.sectionCard, { backgroundColor: theme.card, borderColor: theme.border, zIndex: 1000, elevation: 1 }]}>
              ...
              {/* ΓöÇΓöÇ Teacher View: Single locked subject with direct mark inputs ΓöÇΓöÇ */}
              {isTeacher && teacherSubject ? (
                <View style={styles.teacherMarksPanel}>
                  ...
                  {/* Subject row ΓÇö subject name locked, marks editable */}
                ...
                /* ΓöÇΓöÇ Admin View: Multi-subject management ΓöÇΓöÇ */
                <>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={[{ width: '92%', maxWidth: scale(400), borderRadius: scale(16), padding: scale(16), elevation: 8, maxHeight: '85%' }, { backgroundColor: theme.card }]}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: scale(12), paddingRight: scale(32) }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: scale(16), fontWeight: '700', color: theme.text }} numberOfLines={1}>{selectedExamForOptions?.studentName || 'Student'}</Text>
                <Text style={{ fontSize: scale(12), color: theme.textSecondary, marginTop: scale(1) }}>
                  ID: {selectedExamForOptions?.rollNo || 'N/A'} ΓÇó {selectedExamForOptions?.studentClass || 'N/A'}
                </Text>
              </View>
            </View>
                      ...
                      {visibleTitles.map((t) => {
                        ...
                        return (
                          <TouchableOpacity
                            ...
                            style={{
                              paddingHorizontal: scale(10), paddingVertical: scale(4), borderRadius: scale(6),
                              backgroundColor: isActive ? theme.primary : hasRecord ? theme.primary + '10' : theme.background,
                              borderWidth: 1,
                              borderColor: isActive ? theme.primary : hasRecord ? theme.primary + '30' : theme.border,
                              minWidth: scale(36), alignItems: 'center',
                            }}
                          >
                            <Text style={{ fontSize: scale(11), fontWeight: '700', color: isActive ? '#fff' : hasRecord ? theme.primary : theme.textSecondary }}>{t}</Text>
                          </TouchableOpacity>
                        );
                      })}
                    </View>
            ...
            {/* Test & Date Badge */}
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginBottom: scale(10), gap: scale(6) }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.primary + '10', paddingHorizontal: scale(8), paddingVertical: scale(4), borderRadius: scale(4) }}>
                <Ionicons name="document-text-outline" size={11} color={theme.primary} style={{ marginRight: scale(4) }} />
                <Text style={{ fontSize: scale(11), fontWeight: '600', color: theme.primary }}>{selectedExamForOptions?.title}</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.background, paddingHorizontal: scale(8), paddingVertical: scale(4), borderRadius: scale(4), borderWidth: 1, borderColor: theme.border }}>
                <Ionicons name="folder-outline" size={11} color={theme.textSecondary} style={{ marginRight: scale(4) }} />
                <Text style={{ fontSize: scale(11), color: theme.textSecondary }}>{selectedExamForOptions?.category}</Text>
              </View>
              {selectedExamForOptions?.date && (
                <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: theme.background, paddingHorizontal: scale(8), paddingVertical: scale(4), borderRadius: scale(4), borderWidth: 1, borderColor: theme.border }}>
                  <Ionicons name="calendar-outline" size={11} color={theme.textSecondary} style={{ marginRight: scale(4) }} />
                  <Text style={{ fontSize: scale(11), color: theme.textSecondary }}>{selectedExamForOptions?.date}</Text>
                </View>
              )}
            </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flexShrink: 1 }}>
              ...
              {(() => {
                ...
                let displayTotal = sel?.totalMarks || 'ΓÇö';
                let displayObtained = sel?.obtainedMarks || 'ΓÇö';
                ...
                const percentage = displayTotal !== 'ΓÇö' && displayObtained !== 'ΓÇö' && parseFloat(displayTotal) > 0
                ...
                return (
                  <View style={{ flexDirection: 'row', gap: scale(6), marginBottom: scale(12) }}>
                    <View style={{ flex: 1, borderRadius: scale(6), paddingVertical: scale(6), alignItems: 'center', borderWidth: 1, backgroundColor: sel?.status === 'Pass' ? '#E8F5E910' : sel?.status === 'Fail' ? '#FFEBEE10' : '#FFF3E010', borderColor: sel?.status === 'Pass' ? '#2E7D3225' : sel?.status === 'Fail' ? '#C6282825' : '#EF6C0025' }}>
                    ...
                    <View style={{ flex: 1, backgroundColor: theme.background, borderRadius: scale(6), paddingVertical: scale(6), alignItems: 'center', borderWidth: 1, borderColor: theme.border }}>
                      ...
                      <Text style={{ fontSize: scale(17), fontWeight: '800', color: '#fff', flex: 1 }}>
                        {(() => {
                          ...
                          return pos > 0 ? `${pos}/${sorted.length}` : 'ΓÇö';
                        })()}
                      </Text>
                    </View>
                  </View>
              ...
              {selectedExamForOptions?.books && selectedExamForOptions.books.length > 0 && (
                <View style={{ marginBottom: scale(12), backgroundColor: theme.background, borderRadius: scale(8), borderWidth: 1, borderColor: theme.border, overflow: 'hidden' }}>
                  ...
                  {selectedExamForOptions.books.map((book, idx) => (
                    <View key={idx} style={{ flexDirection: 'row', paddingVertical: scale(6), paddingHorizontal: scale(10), alignItems: 'center', backgroundColor: idx % 2 === 0 ? 'transparent' : theme.card + '60', borderBottomWidth: idx < selectedExamForOptions.books!.length - 1 ? 0.5 : 0, borderBottomColor: theme.border }}>
            ...
            <View style={{ flexDirection: 'row', gap: scale(8), paddingTop: scale(10), marginTop: 'auto' }}>
              ...
              >
                <Ionicons name="create-outline" size={14} color="#fff" style={{ marginRight: scale(4) }} />
...
const styles = StyleSheet.create({
  // ΓöÇΓöÇΓöÇ Main Container & Header ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  container: { flex: 1 },
  ...
  // ΓöÇΓöÇΓöÇ Table View ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Modals ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Form Components ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Book Management ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Dropdowns & Lists ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Full Screen Form ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

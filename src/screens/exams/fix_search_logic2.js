...
for (const file of files) {
  ...
  const targetStr = "return matchesTestNo && matchesGender;";
  const replacementStr = `const matchesSearch = searchQuery ? (e.studentName || '').toLowerCase().includes(searchQuery.toLowerCase().trim()) : true;

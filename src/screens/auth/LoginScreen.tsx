...
export const LoginScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      try {
        ...
        let userDocSnap = await getDoc(doc(db, 'profile', userCredential.user.uid));
        if (userDocSnap.exists()) {
          ...
          if (userDocSnap.exists()) {
            ...
            const studentSnap = await getDoc(doc(db, 'studentsprofile', userCredential.user.uid));
            ...
            if (studentSnap.exists() || !sSnapshot.empty) {
              await signOut(auth);
              setErrorMsg('Access Denied: You are a student. Please use the Student App to log in.');
              setIsLoading(false);
              return;
            }
          }
  ...
  const handleForgotPassword = () => {
    Alert.alert(
      'Account Security',
      'For security and privacy compliance, teacher credentials are managed centrally by the academy administration.\n\nPlease contact your campus administrator or IT Support Desk directly to request a password reset.',
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={[
                  ...
                  <TextInput
                    ...
                    placeholder="e.g. teacher@theseeksacademy.com"
